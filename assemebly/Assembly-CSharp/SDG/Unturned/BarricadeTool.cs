...
namespace SDG.Unturned
{
	...
	{
		// Token: 0x060033C2 RID: 13250 RVA: 0x0014FB58 File Offset: 0x0014DF58
		...
		// Token: 0x060033C3 RID: 13251 RVA: 0x0014FB88 File Offset: 0x0014DF88
		public static Transform getBarricade(Transform parent, byte hp, ulong owner, ulong group, Vector3 pos, Quaternion rot, ushort id, byte[] state, ItemBarricadeAsset asset)
		{
			if (asset != null)
			{
				...
				{
					transform = UnityEngine.Object.Instantiate<GameObject>(asset.barricade).transform;
				}
				...
				else if (asset.build == EBuild.CLOCK && !Dedicator.isDedicated)
				{
					InteractableClock interactableClock = transform.gameObject.AddComponent<InteractableClock>();
					interactableClock.updateState(asset, state);
				}
